...
__q3__ Remember back to `e-setup02-functions`; how do we look up help for a specific function?
...
Ans: cut_number() comes from ggplot2 package and it makes n groups with (approximately) equal numbers of observations. parse_number() comes from readr package and it drops any non-numeric characters before or after the first number. row_number() comes form the dplyr package and it is a ranking function
```{r q5-task}
help("cut_number")
help("parse_number")
help("row_number")
