...
**Observations**: No, the hypothesis that Ideal cut diamonds are less numerous than other cuts was not correct. From the count chart, we see that Ideal cuts are the most numerous. 
...
**Observations**: Since there are so many observations, the points in this scatter plot overlap so much that we cannot make a conclusion. There is no way to see the spread or concentration of data points.
...
**Observations**: This boxplot makes the data easier to analyze. It appears that Hypothesis 2 was not correct in saying that Ideal cut diamonds are the most pricey. The median price of Ideal diamonds is the lowest of all five levels of cut.
...
**Observations**: It appears that some of the lower quality cut diamonds like Fair diamonds have very high carat values, over the other diamonds cuts that have higher quality.
